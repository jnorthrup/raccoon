    ...
    protected void runStagePrivately() {
        switch (_currentStage) {
            case -1:
                setCurrentStage(0);
                _multipliedSMResult =
                        _engine.multiply(this, _m, _bm);
                _mInverseResult = _engine.inverse(this, _m);
                break;
            ...
            case 0:
                if (_mInverseResult.isFinished() && _multipliedSMResult.isFinished()) {
                    ...
                    _multipliedInverseMultipliedSMResult =
                            _engine.multiply(this, _mInverseResult.getResult(), _multipliedSMResult.getResult());
            ...
            case 1:
                if (_multipliedInverseMultipliedSMResult.isFailed())
                    ...
                    setCurrentStage(2);
                    _finalEqualityResult = _engine.checkEquality(this, _multipliedInverseMultipliedSMResult.getResult(), _bm);
                }
                break;
